...
#    這行會找出 pages/ 下面所有的 Python 檔，並依照檔名排序 (1_, 2_, 3_...)
pages_dir = "pages"
...
META_INFO = {
    ...
    "3_Talmud_Strategy": {
        ...
        "icon": "⚖️",
        "tags": ["資產配置", "再平衡", "低風險"],
        "desc": "猶太經典智慧三分法。將資產分為「不動產、股票、現金」，透過定期再平衡 (Rebalance) 機制，自動實現高出低進。"
    }
}
...
for file_path in page_files:
    # 取得檔名 (不含路徑與副檔名)，例如 "3_Talmud_Strategy"
